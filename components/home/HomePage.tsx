        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <Link
                href="/control-tower"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-brand-primary text-white text-sm font-semibold rounded-md hover:bg-brand-primary/90 transition-colors"
              >
                Open Control Tower
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/control-tower"
                  className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-brand-primary text-white font-semibold rounded-md hover:bg-brand-primary/90 transition-colors"
                >
                  Get Started
                  <ArrowRight className="w-4 h-4" />
                </Link>
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-brand-surface text-brand-dark font-semibold rounded-md border border-brand-border hover:border-brand-primary/30 hover:bg-brand-background transition-colors"
                >
                  Explore Platform
                </button>
              </div>
            ...
            {services.map((service) => {
              ...
              return (
                <Link
                  key={service.title}
                  href={service.href}
                  className="group bg-brand-background border border-brand-border rounded-lg p-6 hover:border-brand-primary/30 hover:shadow-md transition-all"
                >
                  ...
                  <h3 className="font-display text-lg font-bold text-brand-dark mb-2 group-hover:text-brand-primary transition-colors">
                    {service.title}
                  </h3>
                  <p className="text-sm text-brand-secondary leading-relaxed">
                    {service.description}
                  </p>
                  <span className="inline-flex items-center gap-1 text-sm font-semibold text-brand-primary mt-4 group-hover:gap-2 transition-all">
              ...
              {capabilities.map((cap) => {
                ...
                return (
                  <Link
                    key={cap.title}
                    href={cap.href}
                    className="group p-5 bg-brand-surface border border-brand-border rounded-lg hover:border-brand-primary/30 transition-colors"
                  >
          ...
          <div className="relative bg-brand-dark rounded-lg overflow-hidden">
            ...
            <div className="relative px-8 py-16 sm:px-12 sm:py-20 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                <Link
                  href="/control-tower"
                  className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-brand-primary text-white font-semibold rounded-md hover:bg-brand-primary/90 transition-colors"
                >
                  Open Control Tower
                  <ArrowRight className="w-4 h-4" />
                </Link>
                <Link
                  href="/signals"
                  className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-white/10 text-white font-semibold rounded-md border border-white/20 hover:bg-white/15 transition-colors"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <nav className="flex flex-wrap gap-6" aria-label="Footer navigation">
              <Link href="/control-tower" className="text-sm text-brand-muted hover:text-brand-primary transition-colors">
                Control Tower
              </Link>
              <Link href="/network" className="text-sm text-brand-muted hover:text-brand-primary transition-colors">
                Digital Twin
              </Link>
              <Link href="/signals" className="text-sm text-brand-muted hover:text-brand-primary transition-colors">
                Signals
              </Link>
              <Link href="/scenarios" className="text-sm text-brand-muted hover:text-brand-primary transition-colors">
                Rehearsals
              </Link>
              <Link href="/agents" className="text-sm text-brand-muted hover:text-brand-primary transition-colors">
                Agents
              </Link>
              <Link href="/decisions" className="text-sm text-brand-muted hover:text-brand-primary transition-colors">
                Decisions
              </Link>
            </nav>
          </div>
